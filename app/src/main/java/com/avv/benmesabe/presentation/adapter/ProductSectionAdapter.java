...
/**
 * Created by angelvazquez on 7/11/15.
 */
public class ProductSectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ProductAdapter mBaseAdapter;
    private SparseArray<Section> mSections = new SparseArray<Section>();

    public ProductSectionAdapter(Context context, int sectionResourceId, int textResourceId,
                                 ProductAdapter baseAdapter) {
    ...
    public class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private void expandItems(int position) {
            notifyItemRangeInserted(position + 1, 5);
        }

        private void collapseItems(int position) {
            notifyItemRangeRemoved(position + 1, 5);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ...
            mBaseAdapter.onBindViewHolder((ProductAdapter.ProductViewHolder)sectionViewHolder, sectionedPositionToPosition(position));
        }
    }
