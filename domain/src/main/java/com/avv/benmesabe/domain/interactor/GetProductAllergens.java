 ...
 */
public class GetProductAllergens extends UseCase {

    private Number productId;
    private final BenMeSabeRepository benMeSabeRepository;

    @Inject
    public GetProductAllergens(Number productId, BenMeSabeRepository benMeSabeRepository, ThreadExecutor threadExecutor,
    ...
    @Override public Observable buildUseCaseObservable() {
        return this.benMeSabeRepository.getProductAllergens(productId);
    }
